...
class Solution(models.Model):
    username=models.ForeignKey(User,max_length=50,on_delete=models.CASCADE,default=None)
    problem_code=models.ForeignKey(Problem,on_delete=models.CASCADE,default=None)
    language=models.CharField(max_length=7,choices=(("c","C"),("cpp","C++"),("py","Python"),("java","Java")))
